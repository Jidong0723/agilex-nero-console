...
class DatasetRecorder:
    ...
    def _sample(self, timeline_index: int) -> dict[str, Any] | None:
        active, target = self.active, time.monotonic_ns(); osc = self.osc.state() or {}
